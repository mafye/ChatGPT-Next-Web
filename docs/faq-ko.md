...
이 기능을 끄면 ���용자가 웹사이트를 처음 방문할 때 모든 리소스를 로드하므로 인터넷 연결 상태가 좋지 않은 경우 흰색 화면이 길게 표시되어 사용자 경험에 영향을 줄 수 있으므로 사용자가 직접 고려하시기 바랍니다.
...
OpenAI의 청구 지���은 https://openai.com/pricing#language-models 에서 확인할 수 있습니다.  
